...
liked_df = pd.read_csv('saved_tracks_doublelock.csv', header=0)
...
def userSongIdentification(userSet, clusterIn):
  outSet = clusterIn.difference(userSet)
  print(outSet)
  return outSet
...
my_playlist = spotify_client.user_playlist_create(user=username, name='Playlisteners - Emmett', public=False)
